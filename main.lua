...
BackgroundImage.Image = "rbxassetid://6632189901" -- 🌄 Пейзаж (горы, лес, озеро)
...
BackgroundDarken.BackgroundTransparency = 0.5
...
DarkenCorner.CornerRadius = UDim.new(0, 10)
...
ScaleInput.BackgroundTransparency = 0.3
...
function ApplyHitboxToPlayer(otherPlayer)
...
HitboxTab.MouseButton1Click:Connect(function()
    ...
    ViewTab.BackgroundTransparency = 0.2
    ViewTab.TextColor3 = Color3.fromRGB(180, 180, 210)
end)
...
ViewTab.MouseButton1Click:Connect(function()
    ...
    ViewTab.BackgroundTransparency = 0
